...
public class Reclamation {
    ...
    public Reclamation(String title, String description, TypeReclamation typeReclamation, int userId) {
        setTitle(title);
        setDescription(description);
        this.typeReclamation = typeReclamation;
        this.createdAt = LocalDateTime.now();
    ...
    public Reclamation(int id, String title, String description, TypeReclamation typeReclamation, int userId) {
        this.id = id;
        setTitle(title);
        setDescription(description);
        this.typeReclamation = typeReclamation;
    ...
    public Reclamation(int id, String title, String description, TypeReclamation typeReclamation, LocalDateTime createdAt, int userId) {
        this.id = id;
        setTitle(title);
        setDescription(description);
        this.typeReclamation = typeReclamation;
