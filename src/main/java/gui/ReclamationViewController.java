...
public class ReclamationViewController implements Initializable {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ReclamationViewController.class);
    ...
    private void setupListView() {
        try {
                ...
                protected void updateItem(Reclamation reclamation, boolean empty) {
                    ...
                    pdfButton.setOnAction(e -> {
                        try {
                            ...
                            LOGGER.error("Erreur lors de la génération du PDF", ex);
            ...
            LOGGER.error("Erreur lors de la configuration de la ListView: " + e.getMessage(), e);
    ...
    private void setupFilters() {
        try {
            ...
            LOGGER.error("Erreur lors de la configuration des filtres: " + e.getMessage(), e);
    ...
    private void loadReclamations() {
        try {
            ...
            LOGGER.error("Erreur lors du chargement des réclamations: " + e.getMessage(), e);
    ...
    private void filterReclamations() {
        try {
            ...
            LOGGER.info("Filtrage terminé. {} réclamations affichées", filteredList.size());
        } catch (Exception e) {
            LOGGER.error("Erreur lors du filtrage des réclamations: " + e.getMessage(), e);
    ...
    private void handleSort() {
        try {
            ...
            LOGGER.info("Tri effectué avec succès");
        } catch (Exception e) {
            LOGGER.error("Erreur lors du tri des réclamations: {}", e.getMessage(), e);
    ...
    private void updateSort() {
        try {
            ...
            LOGGER.info("Liste triée avec succès - {} réclamations", sortedList.size());
        } catch (Exception e) {
            LOGGER.error("Erreur lors de la mise à jour du tri: {}", e.getMessage(), e);
    ...
    private void handleEditReclamation() throws IOException {
        ...
        ((Stage) reclamationListView.getScene().getWindow()).close();
    }
    ...
    private void showReclamationDetails(Reclamation reclamation) {
        try {
            ...
            LOGGER.error("Erreur lors de l'affichage des détails: " + e.getMessage(), e);
