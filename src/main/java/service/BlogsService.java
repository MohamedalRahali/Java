...
public class BlogsService implements IService<Blogs> {
    ...
    @Override
    public boolean add(Blogs blog) throws SQLException {
        String sql = "INSERT INTO blogs (titre, descr, date_crea, date_pub, auteur_id) VALUES (?, ?, ?, ?, ?)";
    ...
    @Override
    public boolean update(Blogs blog) throws SQLException {
    ...
    public List<Blogs> getAll() throws SQLException {
        ...
        String query = "SELECT b.*, t.id as type_id, t.libelle as type_libelle, b.auteur_id FROM blogs b LEFT JOIN type_b t ON b.type_id = t.id";
